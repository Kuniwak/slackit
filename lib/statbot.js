 ...
 * @param {Object<string, string>|string} obj Message text or object that should
 *    have a message as a `text` property. You can specify a channel as a
