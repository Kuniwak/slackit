 ...
 * @param {function=} opt_callback Callback wil be invoked when the statbot
 *    started listening.
 */
BasicBot.prototype.listen = function(opt_callback) {
  this.receivingMechanism.listen(opt_callback);
};
...
/** @override */
BasicBot.prototype.start = function() {
  this.sendingMechanism.start();
  this.receivingMechanism.start();
};


/** @override */
BasicBot.prototype.stop = function() {
  this.sendingMechanism.stop();
  this.receivingMechanism.stop();
};
